...
var constructPicker = (e, minDateStr, maxDateStr, blockedDays) => {
   ...
   var initialDate = getCurrentDateStr();
...
var constructGrid = (maxD, minD, focusD, blocked)=> {
   ...
   var grid = `<caption><img id="up" src="./up.png"><span>${monthName[focusD.getMonth()]} ${focusD.getFullYear()}</option>
   </span><img id="down" src="./down.png">
   </caption>
<tr>
    <th>Su</th>
    <th>M</th>
